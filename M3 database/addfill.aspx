<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addfill.aspx.cs" Inherits="M3_database.addfill" %>
       ...
       <ul>
        ...
        <div>
            ...
            <asp:Label Text="Thesis SerialNumber" CssClass="lblname"  runat="server" />
                <asp:DropDownList ID="DropDownList2" runat="server" DataSourceID="SqlDataSource3" DataTextField="title2" DataValueField="title2" CssClass="drop" required="true">
                </asp:DropDownList>
          <!--
           <asp:Label Text="Thesis SerialNumber" CssClass="lblnamee"  runat="server" />
            <asp:TextBox ID="serial"  runat ="server" CssClass="txttypee" placeholder="Add Serialnumber" TextMode="Number"/>
             -->
              <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:Milestone3 %>" SelectCommand="liststudentongoing" SelectCommandType="StoredProcedure">
                    <SelectParameters>
...
<br />
       ...
       <asp:SqlDataSource ID="dr" runat="server" ConnectionString="<%$ ConnectionStrings:Milestone3 %>"
           SelectCommand="SELECT * FROM [GUCianProgressReport] WHERE ([sid] = @sid)"
             UpdateCommand="exec FillProgressReport @thesisSerialNo , @progressReportNo, @state , @description ,@studentID "
           InsertCommand="AddProgressReport" InsertCommandType="StoredProcedure"
            >
                <UpdateParameters>
