    ...
    public partial class Examiner_login : System.Web.UI.Page
    {
        ...
        protected void submitcomment_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                AddCommentsGrade.Parameters.Add(new SqlParameter("@comment", comm));
                conn.Open();
    ...
    protected void addgrade_Click(object sender, EventArgs e)
      ...
      //  protected void GridView1_RowEditing(object sender, GridViewEditEventArgs e)
        //{   GridView1.EditIndex = e.NewEditIndex;
          //  Session["thesisserial_Examiner"] = GridView1.Rows[GridView1.EditIndex].Cells[0].Text.ToString();
           // Session["DefenseDate_Examiner"] = GridView1.Rows[GridView1.EditIndex].Cells[1].Text;}
