     ...
     <div class ="loginbox"> 
       <img src="img/user.png" alt =" Alternative Text" class ="user"/> 
        ...
        <form id="form1" runat="server">
            ...
            <asp:TextBox ID="GPA"  runat ="server" CssClass="txttype" placeholder="Enter your GPA " required="true" TextMode="Number"/>
                    <asp:TextBox ID="phone"  runat="server" CssClass="txttype" placeholder="phone number" TextMode="Number" required="true" />
           ...
           <br />
            ...
            <br />
                                <asp:Label ID="wrong" Text="An account already exists with this email address" CssClass="wronggg"  runat="server" Visible="false"/>
                                            <asp:Label ID="Label1" Text="An account already exists with this undergradID" CssClass="wronggg"  runat="server" Visible="false"/>
                                      <asp:Label ID="Label2" Text="An account already exists with this phonenumber" CssClass="wronggg"  runat="server" Visible="false"/>
